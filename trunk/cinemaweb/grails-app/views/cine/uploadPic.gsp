...
<head>
	...
	<title>Cinema Web - Cine Foto</title>
	<style type="text/css">
	.col-md-6{margin:0px;}
...
<div class="row">
	<div class="col-md-8">
		...
		<g:uploadForm action="uploadPic" id="${cine.id}" class="form-horizontal">
		<div class="form-group">
			<label class="col-md-2 col-sm-2 control-label">Foto actual:</label>
			<div class="col-md-6">
				<p style="padding-top: 7px"><i>${cine.foto ?: "No hay foto"}</i></p>
			</div>	
		</div>
		<div class="form-group">
			<div class="col-md-8">
		...
		<div class="form-group">
			<div class="col-sm-10 col-md-2">
				...
				<g:link controller="cine" action="show" id="${cine.id}" class="btn btn-default btn-block">Volver</g:link>
			</div>
			<div class="col-sm-10 col-md-2">
