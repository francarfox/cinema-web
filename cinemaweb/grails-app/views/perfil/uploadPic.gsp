...
<body>
	<div class="container">
		<div class="row">
			<h1>Subir foto de ${perfil.nombre}</h1>
			...
			<div class="col-md-7">
				...
				<g:uploadForm action="uploadPic" id="${perfil.id}" class="form-horizontal">
					<div class="form-group">
						<div class="col-md-5" style="margin-left:0px;">
							<p style="margin-bottom:15px;"><strong>Foto actual:</strong>  <i>${perfil.foto ?: "No hay foto"}</i></p>
			...
			<div class="col-sm-10 col-md-2">
				...
				<g:link controller="perfil" action="show" id="${perfil.id}" class="btn btn-lg btn-large btn-crearcirculo"><i class="fa fa fa-reply"></i> Volver</g:link>
			</div>
			</g:uploadForm>
		</div>	
	</div>	
